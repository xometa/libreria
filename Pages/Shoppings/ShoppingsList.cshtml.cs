...
{
    public class ShoppingsListModel : PageModel
    {
        private bookstoreContext _context { get; }
        public UploadImage UploadImage { get; set; }
        public string page { get; set; }
        public bool task { get; set; }
        public ShoppingsListModel(bookstoreContext context)
        {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            if (idUser != null)
            {
                ...
                {
                    task = await UploadImage.accessUser(idUser.Value, "Compras", "/Shoppings/ShoppingsList");
                    if (task)
                    {
                        return Page();
                    }
